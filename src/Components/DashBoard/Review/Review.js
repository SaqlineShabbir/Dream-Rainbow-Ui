          ...
          <div className="reviews-main">
            <div className="reviews-text-main">
              <div className="reviews-text">
                ...
                <p className="text-center w-50 mx-auto my-4">
              ...
              <Slider {...settings}>
                {reviews?.map((review) => (
                  <div className="py-4 px-1 px-lg-4" key={review._id}>
                    <img
                      src="https://i.postimg.cc/yx3nsc6K/avatar.png"
                      className="img-rounded w-25 border border-5"
                      alt=""
